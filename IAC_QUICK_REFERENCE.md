...
### SageMaker Cost Details

**Current Configuration**:
- **Instance**: ml.m5.large
- **Cost**: $0.115/hour × 730 hours = **$84/month**
- **Use Case**: Production embedding generation

**Alternative Options**:
| Option | Cost/Month | Best For | Trade-off |
|--------|-----------|----------|-----------|
| ml.t3.medium | $36 | Dev/Testing, < 100 docs/day | Slower (50 chunks/min) |
| ml.m5.large | $84 | **Production**, 1K docs/day | **Balanced** |
| ml.m5.xlarge | $168 | High volume, 10K docs/day | Higher cost |
| Serverless | $0.20-$10 | Low/sporadic usage | Cold starts |

**Cost Optimization**:
- 💡 Use **ml.t3.medium** for dev: Save $48/month
- 💡 Enable **auto-scaling**: Scale to 0 during idle
- 💡 Use **Serverless Inference**: Pay only for usage (< 1000 docs/day)
